...
export const useTranslation = () => {
  ...
  const getFallbackText = (key: string, options?: { defaultValue?: string }): string => {
    ...
    const fallbacks: Record<string, string> = {
      ...
      'contact.subtitle': 'Que vous soyez transporteur, établissement ou patient, notre équipe est là pour vous.',
      'contact.form.firstName': 'Prénom',
      'contact.form.lastName': 'Nom',
      'contact.form.email': 'Email',
      'contact.form.userType': 'Vous êtes',
      'contact.form.userTypePlaceholder': 'Sélectionnez votre profil',
      'contact.form.userTypes.transporter': 'Transporteur sanitaire',
      'contact.form.userTypes.healthcare': 'Établissement de santé',
      'contact.form.userTypes.patient': 'Patient',
      'contact.form.userTypes.other': 'Autre',
      'contact.form.message': 'Message',
      'contact.form.messagePlaceholder': 'Décrivez vos besoins ou posez votre question...',
